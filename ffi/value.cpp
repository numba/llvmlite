...
LLVMPY_GetConstantIntRawValue(LLVMValueRef Val, LLVMBool* littleEndian) {
    if (littleEndian) {
...
API_EXPORT(double)
LLVMPY_GetConstantFPValue(LLVMValueRef Val, LLVMBool *losesInfo) { return LLVMConstRealGetDouble(Val, losesInfo); }
