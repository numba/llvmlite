...
LLVMPY_CreateLegacyPassManager() { return LLVMCreatePassManager(); }

API_EXPORT(void)
LLVMPY_DisposeLegacyPassManager(LLVMPassManagerRef PM) {
    return LLVMDisposePassManager(PM);
}

API_EXPORT(LLVMPassManagerRef)
LLVMPY_CreateLegacyFunctionPassManager(LLVMModuleRef M) {
    return LLVMCreateFunctionPassManagerForModule(M);
}

API_EXPORT(int)
LLVMPY_RunPassManagerWithLegacyRemarks(LLVMPassManagerRef PM, LLVMModuleRef M,
...
API_EXPORT(int)
LLVMPY_RunLegacyPassManager(LLVMPassManagerRef PM, LLVMModuleRef M) {
    return LLVMRunPassManager(PM, M);
}

API_EXPORT(int)
LLVMPY_RunLegacyFunctionPassManagerWithRemarks(LLVMPassManagerRef PM,
                                               LLVMValueRef F,
                                               const char *remarks_format,
                                               const char *remarks_filter,
                                               const char *record_filename) {
...
API_EXPORT(int)
LLVMPY_RunLegacyFunctionPassManager(LLVMPassManagerRef PM, LLVMValueRef F) {
    return LLVMRunFunctionPassManager(PM, F);
}

API_EXPORT(int)
LLVMPY_InitializeLegacyFunctionPassManager(LLVMPassManagerRef FPM) {
    return LLVMInitializeFunctionPassManager(FPM);
}

API_EXPORT(int)
LLVMPY_FinalizeLegacyFunctionPassManager(LLVMPassManagerRef FPM) {
...
API_EXPORT(void)
LLVMPY_PassManagerBuilderPopulateLegacyModulePassManager(
