...
class NewModulePassManager(ffi.ObjectRef):
    ...
    def add_aa_eval_pass(self):
        ffi.lib.LLVMPY_AddAAEvalPassNMPM(self)   
...
class NewFunctionPassManger(ffi.ObjectRef):
    ...
    def add_aa_eval_pass(self):
        ffi.lib.LLVMPY_AddAAEvalPassNFPM(self)
...
class PipelineTuningOptions(ffi.ObjectRef):
    ...
    # FIXME: Model optimization level combining opt level and size level similar to llvm
    # @property
    # def size_level(self):
    #     """
...
class PassBuilder(ffi.ObjectRef):
    ...
    def getNewModulePassManager(self):
        return NewModulePassManager(
            ffi.lib.LLVMPY_buildPerModuleDefaultPipeline(self, self._pto.opt_level)
        )

    def getNewFunctionPassManager(self):
        return NewFunctionPassManger(
            ffi.lib.LLVMPY_buildFunctionSimplificationPipeline(self, self._pto.opt_level)
        )
...
ffi.lib.LLVMPY_AddAAEvalPassNMPM.argtypes = [ffi.LLVMModulePassManagerRef,]
ffi.lib.LLVMPY_AddSimplifyCFGPass_module.argtypes = [ffi.LLVMModulePassManagerRef,]
ffi.lib.LLVMPY_AddLoopUnrollPass_module.argtypes = [ffi.LLVMModulePassManagerRef,]
ffi.lib.LLVMPY_LLVMAddLoopRotatePass_module.argtypes = [ffi.LLVMModulePassManagerRef,]
ffi.lib.LLVMPY_LLVMAddInstructionCombinePass_module.argtypes = [ffi.LLVMModulePassManagerRef,]
ffi.lib.LLVMPY_AddJumpThreadingPass_module.argtypes = [ffi.LLVMModulePassManagerRef,]
ffi.lib.LLVMPY_DisposeNewModulePassManger.argtypes = [ffi.LLVMModulePassManagerRef,]
...
ffi.lib.LLVMPY_AddAAEvalPassNFPM.argtypes = [ffi.LLVMFunctionPassManagerRef,]
ffi.lib.LLVMPY_AddSimplifyCFGPass_function.argtypes = [ffi.LLVMFunctionPassManagerRef,]
ffi.lib.LLVMPY_AddLoopUnrollPass_Function.argtypes = [ffi.LLVMFunctionPassManagerRef,]
ffi.lib.LLVMPY_LLVMAddLoopRotatePass_function.argtypes = [ffi.LLVMFunctionPassManagerRef,]
ffi.lib.LLVMPY_LLVMAddInstructionCombinePass_function.argtypes = [ffi.LLVMFunctionPassManagerRef,]
ffi.lib.LLVMPY_AddJumpThreadingPass_function.argtypes = [ffi.LLVMFunctionPassManagerRef, c_int,]
ffi.lib.LLVMPY_DisposeNewFunctionPassManger.argtypes = [ffi.LLVMFunctionPassManagerRef,]
...
ffi.lib.LLVMPY_buildPerModuleDefaultPipeline.argtypes = [ffi.LLVMPassBuilderRef, c_int,]

ffi.lib.LLVMPY_buildFunctionSimplificationPipeline.restype = ffi.LLVMFunctionPassManagerRef
ffi.lib.LLVMPY_buildFunctionSimplificationPipeline.argtypes = [ffi.LLVMPassBuilderRef, c_int,]
...
ffi.lib.LLVMPY_PTOGetLoopInterleaving.argtypes = [ffi.LLVMPipelineTuningOptionsRef,]

ffi.lib.LLVMPY_PTOSetLoopInterleaving.argtypes = [ffi.LLVMPipelineTuningOptionsRef, c_bool]

ffi.lib.LLVMPY_PTOGetLoopVectorization.restype = c_bool
ffi.lib.LLVMPY_PTOGetLoopVectorization.argtypes = [ffi.LLVMPipelineTuningOptionsRef,]

ffi.lib.LLVMPY_PTOSetLoopVectorization.argtypes = [ffi.LLVMPipelineTuningOptionsRef, c_bool]

ffi.lib.LLVMPY_PTOGetSLPVectorization.restype = c_bool
ffi.lib.LLVMPY_PTOGetSLPVectorization.argtypes = [ffi.LLVMPipelineTuningOptionsRef,]

ffi.lib.LLVMPY_PTOSetSLPVectorization.argtypes = [ffi.LLVMPipelineTuningOptionsRef, c_bool]

ffi.lib.LLVMPY_PTOGetLoopUnrolling.restype = c_bool
ffi.lib.LLVMPY_PTOGetLoopUnrolling.argtypes = [ffi.LLVMPipelineTuningOptionsRef,]

ffi.lib.LLVMPY_PTOSetLoopUnrolling.argtypes = [ffi.LLVMPipelineTuningOptionsRef, c_bool]
ffi.lib.LLVMPY_DisposePipelineTuningOptions.argtypes = [ffi.LLVMPipelineTuningOptionsRef,]
