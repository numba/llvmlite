...
class TypeRef(ffi.ObjectRef):
    ...
    def is_pointer(self) -> bool:
        ...
        """
        return _cast(bool, ffi.lib.LLVMPY_TypeIsPointer(self))
    ...
    def __str__(self) -> str:
        return _cast(str, ffi.ret_string(ffi.lib.LLVMPY_PrintType(self)))
...
class ValueRef(ffi.ObjectRef):
    ...
    def __init__(self, ptr: Any, kind: str | None, parents: dict[str, Any]) -> None:
        self._kind = kind
    ...
    def is_declaration(self) -> bool:
        ...
        if not (self.is_global or self.is_function):
            raise ValueError('expected global or function value, got %s'
                             % (self._kind,))
        return _cast(bool, ffi.lib.LLVMPY_IsDeclaration(self))
