...
class ModulePassManager(ffi.ObjectRef):
    ...
    def __init__(self, ptr=None):
        if ptr is None:
            ptr = ffi.lib.LLVMPY_CreateModulePassManager()
        ffi.ObjectRef.__init__(self, ptr)

    def run(self, module, pb):
        ffi.lib.LLVMPY_RunModulePassManager(self, pb, module)
...
class FunctionPassManager(ffi.ObjectRef):
    ...
    def run(self, fun, pb):
        ffi.lib.LLVMPY_RunFunctionPassManager(self, pb, fun)
...
ffi.lib.LLVMPY_CreateModulePassManager.restype = ffi.LLVMModulePassManagerRef

ffi.lib.LLVMPY_RunModulePassManager.argtypes = [
    ffi.LLVMModulePassManagerRef, ffi.LLVMPassBuilderRef, ffi.LLVMModuleRef,]
